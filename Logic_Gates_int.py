...
for point in Table:
	if counter < gate_count:
		...
		small_statement = str(input('Enter the small statement in the form (123) where 2 is the gate or (01) for NOT 1 \n'))
		...
		if len(small_statement) == 2:
			while small_statement[0] != 0:
				small_statement = str(input('Invalid gate number, re-enter the small statement in the form (123) \n'))
				small_statement = small_statement.split()
				for i in range(0,2):
					small_statement.append(int(small_statement[0][i]))
				small_statement.pop(0)
			while small_statement[1]-1 not in range(0,len(Table)):
				small_statement = str(input('Re-enter the small statement in the form (123) where 2 is the gate \n'))
				small_statement = small_statement.split()
				for i in range(0,3):
					small_statement.append(int(small_statement[0][i]))
				small_statement.pop(0)
			...
			while small_statement[1] > 5 or small_statement[1] < 0:
				small_statement = input('Invalid gate number, re-enter the small statement in the form (123) \n')
				small_statement = small_statement.split()
				for i in range(0,3):
					small_statement.append(int(small_statement[0][i]))
				small_statement.pop(0)
			while small_statement[0]-1 not in range(0,len(Table)) or small_statement[2]-1 not in range(0,len(Table)):
				small_statement = input('Re-enter the small statement in the form (123) where 2 is the gate \n')
				small_statement = small_statement.split()
				for i in range(0,3):
					small_statement.append(int(small_statement[0][i]))
				small_statement.pop(0)
